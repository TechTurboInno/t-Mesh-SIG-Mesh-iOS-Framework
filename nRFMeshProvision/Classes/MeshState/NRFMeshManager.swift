...
public struct NRFMeshManager {
    ...
    public mutating func setCurrentNodeUnicast(_ aNodeUnicast: Data) {
        targetNodeUnicast = aNodeUnicast
    }
    
    public mutating func setNodeEntry(_ aNodeUnicast: Data) {
        targetNodeUnicast = aNodeUnicast
    }
    
    public func currentUnicast() -> Data? {
        return targetNodeUnicast
    }
